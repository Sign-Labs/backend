...
const lesson = {
  title: "บทเรียนที่ 1: พยัญชนะ",
  description: "เรียนรู้เกี่ยวกับพยัญชนะ",
  questions: [
    {
      question_text: "รูปภาพนี้คือพยัญชนะอะไร?",
      image_url: "/images/elephant.jpg",
      choices: [
        { choice_text: "q", image_url: "", is_correct: true },
        { choice_text: "w", image_url: "", is_correct: false },
        { choice_text: "e", image_url: "", is_correct: false },
         { choice_text: "r", image_url: "", is_correct: false }
      ]
    }
...
await insertLessonWithQuestions(lesson);